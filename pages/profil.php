  ...
  <div class="profil-grid">
    ...
    <div class="section-box">
      ...
      <form method="POST">
        ...
        <input class="form-input" type="text" name="nama" value="<?= htmlspecialchars($userData['nama']) ?>" required />

        <label class="form-label">Email</label>
        <input class="form-input" type="email" name="email" value="<?= htmlspecialchars($userData['email']) ?>"
          required />
